/**
 * Chunk storage layout and index math (§4.1). A chunk is 16x128x16 block ids
 * in one Uint8Array; the index formula is the single source of truth used by
 * worldgen, meshing and the world map alike.
 */
export const CHUNK_SIZE = 16;
export const CHUNK_HEIGHT = 128;
export const CHUNK_VOLUME = CHUNK_SIZE * CHUNK_SIZE * CHUNK_HEIGHT; // 32768

/** Local coords x,z in [0,15], y in [0,127] -> flat index. */
