...
const MOSSY_FLOOR_DIV = 5; // ~1/5 stone cave floors turn to mossstone
const GLOWBLOOM_DIV = 16; // ~1/16 cave floors sprout a glowbloom
const GROTTO_MIN_Y = 72; // crystal grottoes: the deep cave band
const GROTTO_MAX_Y = 94;
const GROTTO_WALL_DIV = 14; // ~1/14 air-adjacent stone cells crystallize
const GROTTO_KNOB_DIV = 6; // ~1 crystallized cell in 6 is a geodeshell knob
const GROTTO_STUB_DIV = 22; // ~1/22 cave floors grow a crystal stub
...
const CINDERCAP_DIV = 14; // ~1/14 cave floors sprout a cindercap
